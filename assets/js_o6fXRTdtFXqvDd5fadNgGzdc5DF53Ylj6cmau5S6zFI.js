...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.dataLayerPush = {
    attach: function (context) {
      ...
      if( $('#block-minifooter').length )
      {
        $( ".field--name-field-cta-button-url a" ).once().click(function() {
      ...
      $('a.language-link').once().click(function () {
        var lang = $(this).text();
      ...
      $( "a.inside-menu-link" ).once().click(function() {
      ...
      if ($('.footer-top').length) {
        $( ".footer-top .container ul li a" ).once().click(function() {
          var url = $(this).attr('href');
          dataLayer.push({
            'event': 'customEvent',
      ...
      if ($('#block-globalmenu').length) {
        $('.menu--global-menu a').once().click(function() {
      ...
      if ($('#blocktabs-search_results_tabs .view-content').length) {
        ...
        $(".views-field-title a").once().click(function () {
      ...
      $('#views-exposed-form-faq-search-faq-search-block .form-submit').once('dataLayerPush').click(function () {
        setTimeout(function () {
      ...
      if ($('.social-media-sharing').length) {
        $(".social-media-sharing a").once().click(function () {
      ...
      if ($('.view-documents-reports').length) {
        $("a.doc-link").once().click(function () {
      ...
      $('.video-embed-field-lazy-play').once().on('click', function () {
      ...
      $('.file-link a').once().click(function () {
        var file = $(this).attr('href');
        dataLayer.push({
          'event': 'customEvent',
          'eventCategory': 'downloads',
...
(function ($, Drupal) {
   ...
   */
  Drupal.behaviors.mosiac_default_topic = {
    attach: function (context, settings) {
      // Using once() with more complexity.
      $('.view-ln-c-mosaic', context).once('.view-ln-c-mosaic').each(function () {
        // Set topic based on hash value.
        var urlParams = location.hash;
        var topic_id = null;
        if (urlParams != null) {
          topic_id = urlParams.split("/");
        }
        if (topic_id[0] == '#topic' && topic_id[1] != null) {
          setTimeout(function() {
            if ($(".mosaic-mobile").css('display') == 'none') {
              // Select topic for Desktop mosiac view.
              $("input[name=field_topic_target_id][value='" + topic_id[1] + "']").prop('checked', 'checked');
              $('#views-exposed-form-ln-c-mosaic-mosaic-block .form-type-radio input:checked')
                .closest('.form-type-radio').addClass('is-checked');
            }
            else if ($(".mosaic-mobile").css('display') == 'block') {
              // Select topic for Mobile mosiac view.
              $('select[id*="edit-field-topic-target-id"].form-select').val(topic_id[1]);
            }
            // Submit form.
            $('button[id*="edit-submit-ln-c-mosaic"]').click();
            $(document).ajaxComplete(function(event, xhr, settings) {
              $('.view-ln-c-mosaic .fieldset-wrapper').css('display', 'block');
...
(function ($) {
  ...
  Drupal.behaviors.dsu_lazy_load = {
    attach: function (context, settings) {
      $('img[data-src]', context).once('lazy-loading-processed').each(function () {
        var bLazy = new Blazy({
          "loadInvisible": true,
        });
      });
